...
const FoodList = () => {
  ...
  const [foodId, setFoodId] = useState(editFood && editFood.id);
  const [foodName, setFoodName] = useState(editFood && editFood.name);
  const [foodPrice, setFoodPrice] = useState(editFood && editFood.price);
